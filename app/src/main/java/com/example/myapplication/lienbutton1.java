...
public class lienbutton1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button buttonToPage = findViewById(R.id.fruitVegButton);
        ...
        buttonToPage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(lienbutton1.this, FruitsVegetablesActivity.class);
